...
final class Flight
{
    ...
    protected const PAD_WITH_LENGTH = 3;
    protected const PAD_STRING = '0';
    ...
    public function getDuration(): string
    {
        ...
        $microseconds = str_pad(strval((int)($this->start->diff($this->finish)->format('%f')) / 1000), self::PAD_WITH_LENGTH, self::PAD_STRING, STR_PAD_LEFT);
